...
TEST_LILE_DIR = '/Users/welcome870117/Desktop/git_project/Quantitative_trading_strategy/trading_system_v3.2/test_log_file.csv'
...
if __name__ == '__main__':
        ...
        if mode == 'strategy':
            ...
            if not os.path.exists(TEST_LILE_DIR):
                test_log_file = pd.DataFrame(columns=['timestamp', 'symbol', 'side', 'strategy', 'quantity', 'USDT_value', 'add_position_price', 'stop_loss_price'])
                test_log_file.to_csv(TEST_LILE_DIR, index=False)
            ...
            for i in range(900, len(test_data)-1):
            ...
            for i in range(20, len(test_data)-1):
                ...
                print('------------')
        '''       
        price_1h = hist_crypto_price(SYMBOL, '1h')       
        #2023-05-22 00:00:00
        #2023-06-30 00:00:00
